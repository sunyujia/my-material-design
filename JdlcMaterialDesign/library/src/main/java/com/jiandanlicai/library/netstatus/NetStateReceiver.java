...
package com.jiandanlicai.library.netstatus;
...
public class NetStateReceiver extends BroadcastReceiver {
    ...
    public final static String CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.yunzhanghu.library.net.conn.CONNECTIVITY_CHANGE";
